        ...
        return(
            <View>
                ...
                <View style={styles.paragraph}>
                    ...
                    <Text style={styles.text}>Therefore, it goes without saying that you are in <Text style={styles.emphasis}>constant</Text> need for protein. Another great thing about protein, is that your body actually burns calories while breaking it down, which helps with preventing obesity.</Text>
